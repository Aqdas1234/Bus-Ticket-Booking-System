...
<head>
   ...
   var flag= false;
		...
		function numCheck(){
			...
			{
				document.getElementById("numErr").innerHTML = "Field Required";
				flag = false;
			}else{
		...
		{
			let flag1 =false;
			/*if(document.getElementsById("type").checked)
			{
				document.getElementById("typeErr").innerHTML = "";
				flag1 = true;
			}else{
			document.getElementById("typeErr").innerHTML = "select class of bus";
				flag1 = false;
			}*/
    ...
    <div class="main_container">
        ...
        <div class="ticketbook_conatainer sign_in_up">
            ...
            <div id="ticketbook_wrapper " class="ticketbook_wrapper sign_in_up_box "  >
                ...
                <form onsubmit = "return validate()" action="addBus" method ="post">
                    
                        <h4>Driver Name</h4>
                        </label>
                        <input type="text" id="dname"  name="dname" placeholder="jhon doe" onblur="return NameCheck()">
                        <span style="color:red" id="NameErr" ></span><br><br>

                        <label for="">
                            <h4>Bus Number</h4>
                        </label>
                        <input type="text" id="number" name="number" placeholder="1223#33" onblur="return numCheck()" >
